    ...
    function Header()
{
    ...
    $this->Text(75, 15, utf8_decode('Clínica IREAR'));
    $this->Text(75, 20, utf8_decode('Dr(a): '.$_SESSION['name'].''));
    $this->Text(75,25, utf8_decode('Tel: 7785-8223'));
    $this->Text(75,30, utf8_decode('clinicaIREAR@gmail.com'));
...
function Footer()
{
     $this->SetFont('helvetica', 'B', 8);
        ...
        $this->Cell(0,5,utf8_decode("clinicaIREAR © Todos los derechos reservados."),0,0,"C");
